...
public class Accountant {
	...
	Bank_Account searchAccount1(String accountNum, String SIN) {
		...
		Bank_Account account = db.searchAccount1(accountNum, SIN);
		db = null;
	...
	public Client searchClient1(String accountNum, String SIN) {
		DB_Handler db = new DB_Handler();
		Client client = db.searchClient1( accountNum, SIN );
		db = null;
		return client;
	}
